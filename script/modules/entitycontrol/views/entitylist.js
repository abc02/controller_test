...
var Entitylist = React.createClass({
    ...
    setTableStyle: function (data){
        ...
        $('.entityList .thead').css('border-left', '1px solid #399af7');
                            ...
                            <tr><td className="thead tableCheck"></td>
                            ...
                            </tr>
                                {
                                    entityList.map(function(item, index) {
                                        return <tr key={index} className="entitylistTr" onMouseOver={handleTrMouseOver} onMouseOut={handleTrMouseOut}><td data-keyname={item[0][1]} className="tableCheck">
                                        {/* <input type="checkbox"/> */}
                                        </td>
